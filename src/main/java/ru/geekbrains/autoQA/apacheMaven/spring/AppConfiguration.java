package ru.geekbrains.autoQA.apacheMaven.spring;
...
@Configuration
@ComponentScan({ "ru.geekbrains.autoQA.apacheMaven" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "ru.geekbrains.autoQA.apacheMaven");
                servletContext.setInitParameter("tapestry.development-modules", "ru.geekbrains.autoQA.apacheMaven.services.DevelopmentModule");
